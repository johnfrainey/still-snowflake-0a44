...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/still-snowflake-0a44
```

A live public deployment of this template is available at [https://still-snowflake-0a44.templates.workers.dev](https://still-snowflake-0a44.templates.workers.dev)
